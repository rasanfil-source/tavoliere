...
const CATALOG_RELEASE = '20260821ae';
...
export const CORE_FALLBACKS = Object.freeze({
  it: Object.freeze({
    ...
    'admin.adaptations.appDisplayName.help': 'Prima riga mostrata nella schermata iniziale. Può modificarla soltanto il responsabile del centro.',
  ...
  en: Object.freeze({
    ...
    'admin.adaptations.appDisplayName.help': 'First line shown on the startup screen. Only the person responsible for the center can change it.',
  ...
  fr: Object.freeze({
    ...
    'admin.adaptations.appDisplayName.help': 'Première ligne affichée sur l’écran de démarrage. Seul le responsable du centre peut la modifier.',
  ...
  es: Object.freeze({
    ...
    'admin.adaptations.appDisplayName.help': 'Primera línea mostrada en la pantalla inicial. Solo la persona responsable del centro puede modificarla.',
  ...
  de: Object.freeze({
    ...
    'admin.adaptations.appDisplayName.help': 'Erste Zeile auf dem Startbildschirm. Nur die für das Zentrum verantwortliche Person kann sie ändern.',
