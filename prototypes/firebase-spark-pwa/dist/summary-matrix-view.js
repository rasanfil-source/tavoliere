import{t as r,getLocale as x}from"./i18n/i18n.mjs?v=20260815q";import{escapeHtml as e}from"./html-utils.js?v=20260815q";import{formatDietLabel as y}from"./diet-utils.mjs?v=20260815q";import{buildKitchenMatrixScreens as R,buildSummaryMatrixScreens as q}from"./summary-matrix-model.js?v=20260815q";let E=0;function ra(a,{days:t=[],operationDays:s=[],kitchen:n=!1,layout:m="classic",activeIndex:i=0,onActiveIndexChange:o=()=>{}}={}){const l=n?R(t,s):q(t,[],s);if(l.every(c=>c.columns.length===0)){a.innerHTML=`<p class="empty-state">${e(r("summary.noMeal"))}</p>`;return}const u=n?"kitchen":"summary",f=m==="international"?_:G;a.innerHTML=`
