import{t as n,getLocale as b}from"./i18n/i18n.mjs?v=20260823g";import{escapeHtml as s}from"./html-utils.js?v=20260816g";import{formatDietLabel as Y,getDietBadgeTone as N,normalizeDietCode as T}from"./diet-utils.mjs?v=20260823c";import{normalizeKitchenDietLegend as _}from"./diet-legend.mjs?v=20260823c";import{buildKitchenMatrixScreens as J,buildSummaryMatrixScreens as Q}from"./summary-matrix-model.js?v=20260820i";let A=0;function Sa(a,{days:t=[],operationDays:e=[],kitchen:r=!1,layout:i="classic",residentLabel:u="name",dietLegend:m=[],showContactHint:c=!0,activeIndex:l=0,onActiveIndexChange:o=()=>{}}={}){const $=r?J(t,e):Q(t,[],e);if(i==="future"&&!r){V(a,$,u,l,o,c);return}if($.every(h=>h.columns.length===0)){a.innerHTML=`<p class="empty-state">${s(n("summary.noMeal"))}</p>`;return}const d=r?"kitchen":"summary",x=i==="international"?ca:sa;a.innerHTML=`
    <div class="summary-matrix-track summary-layout-${i}${r?" summary-layout-kitchen":" summary-layout-diners"}" data-${d}-matrix-track aria-label="${s(n("summary.screensLabel"))}">
      ${$.map(h=>x(h,{kitchen:r,activeIndex:l,residentLabel:u,showContactHint:c,dietLegend:m})).join("")}
    </div>
    <p class="summary-matrix-swipe-hint" aria-hidden="true">${s(n("summary.swipeHint"))}</p>
  `;const f=a.querySelector(`[data-${d}-matrix-track]`);let p=0;f.addEventListener("scroll",()=>{window.clearTimeout(p),p=window.setTimeout(()=>{const h=ha(f,d);U(a,d,h),o(h)},100)},{passive:!0}),window.requestAnimationFrame(()=>{ta(a,l,{kitchen:r,smooth:!1})})}function V(a,t,e,r=0,i=()=>{},u=!0){a.innerHTML=`
      ...
      ${t.map(l=>`
        <article class="summary-future-card" data-summary-future-screen="${l.index}" aria-hidden="${l.index!==r}">
          <header class="summary-future-card-head">
            <div><strong>${s(n(l.labelKey))}</strong><time datetime="${s(l.dateId)}">${s(I(l.dateId))}</time></div>
            ${aa(l)}
          </header>
          <div class="summary-future-meals">
            ${l.columns.map(o=>X(o,e,u)).join("")}
          </div>
        </article>
      `).join("")}
    </div>
  `;const m=a.querySelector("[data-summary-future-track]");let c=0;m?.addEventListener("scroll",()=>{window.clearTimeout(c),c=window.setTimeout(()=>{const l=Math.max(0,Math.min(1,Math.round(m.scrollLeft/Math.max(1,m.clientWidth+14))));m.querySelectorAll("[data-summary-future-screen]").forEach(o=>{o.setAttribute("aria-hidden",String(Number(o.dataset.summaryFutureScreen)!==l))}),i(l)},100)},{passive:!0}),window.requestAnimationFrame(()=>{m&&m.scrollTo({left:Math.max(0,r)*(m.clientWidth+14),behavior:"auto"})})}function X(a,t,e=!0){const r=Array.isArray(a.names)?a.names:[],i=[...Array.isArray(a.specialDiets?.items)?a.specialDiets.items:[]].map(l=>y(l.tag)).filter(Boolean).sort((l,o)=>l.localeCompare(o,b(),{numeric:!0})),u=Number(a.guestCount||0),m=Number(a.sickCount||0),c=Array.isArray(a.sickDiets)?a.sickDiets:[];return`
    <section class="summary-future-meal">
      ...
      ${P(a,e)}
      ${u>0?j("summary.guests",u,"guests"):""}
      ${i.length?`<p class="summary-future-diets"><span>${s(n("summary.diets"))}:</span> <strong>${s(i.join(", "))}</strong></p>`:""}
  ...
  `}function j(a,t,e){return e==="guests"?`<p class="summary-future-metric summary-future-metric-guests"><strong>${s(String(t))}</strong><span>${s(n(a))}</span></p>`:`<p class="summary-future-metric summary-future-metric-${s(e)}"><span>${s(n(a))}</span><strong>${s(String(t))}</strong></p>`}function Z(a,t){const e=String(a.displayName||"").trim().split(/\s+/).filter(Boolean).slice(0,3).map(o=>o[0]).join("").toUpperCase(),r=t==="signature"?a.signature||a.displayName:t==="initials"?a.initials||e||a.signature:a.displayName,i=Array.isArray(a.dietTags)?a.dietTags.map(o=>y(o)).filter(Boolean):[],u=`${s(r||"–")}${i.length?`&nbsp;<small>(${s(i.join(", "))})</small>`:""}`,m=C(a.phone),c=a.phoneConsent&&m?`<a class="summary-matrix-call" href="tel:${s(m)}" aria-label="${s(n("summary.callPerson",{name:a.displayName}))}"><span class="summary-matrix-phone-icon" aria-hidden="true">☎</span></a>`:"",l=a.whatsappEnabled&&a.phoneConsent&&m?`<a class="summary-matrix-whatsapp" href="https://wa.me/${s(m.replace(/\D/g,""))}" target="_blank" rel="noopener noreferrer" aria-label="${s(n("summary.messagePerson",{name:a.displayName}))}" title="WhatsApp"><img src="/icons/whatsapp.svg?v=20260808a" alt="" aria-hidden="true"></a>`:"";if(c||l){const o=`summary-contact-popup-${++A}`;return`<span class="summary-future-person summary-matrix-name-with-popup"><button type="button" class="summary-matrix-person-trigger" popovertarget="${o}" aria-haspopup="dialog" aria-label="${s(n("summary.contactPerson",{name:a.displayName}))}">${u}</button><span class="summary-matrix-contact-popover" id="${o}" popover role="dialog"><span class="summary-matrix-contact-actions">${c}${l}</span></span></span>`}return`<span class="summary-future-person" title="${s(a.displayName||r)}">${u}</span>`}function aa(a){const t=a.columns.find(e=>e.dayIndex===a.index)?.dayMassStatus;return!t||t==="UNKNOWN"?"":B(t)}function B(a){const t=a==="YES";return`<span class="summary-mass-metadata summary-mass-metadata-${t?"yes":"no"}"><span>${s(n("summary.mass"))}:</span><span class="summary-mass-metadata-dot" aria-hidden="true"></span><strong>${s(n(t?"summary.yes":"summary.no"))}</strong></span>`}function ta(a,t,{kitchen:e=!1,smooth:r=!0}={}){const i=e?"kitchen":"summary",u=Number(t)===1?1:0;if(!e){const l=a?.querySelector("[data-summary-future-track]");if(l)return l.scrollTo({left:u*(l.clientWidth+14),behavior:r?"smooth":"auto"}),l.querySelectorAll("[data-summary-future-screen]").forEach(o=>{o.setAttribute("aria-hidden",String(Number(o.dataset.summaryFutureScreen)!==u))}),!0}const m=a?.querySelector(`[data-${i}-matrix-track]`),c=m?.querySelector(`[data-${i}-screen="${u}"]`);return!m||!c?!1:(m.scrollTo({left:m.scrollLeft+c.getBoundingClientRect().left-m.getBoundingClientRect().left,behavior:r?"smooth":"auto"}),U(a,i,u),!0)}function sa(a,{kitchen:t,activeIndex:e,residentLabel:r="name",showContactHint:i=!0,dietLegend:u=[]}){const m=t?"kitchen":"summary",c=a.index===e,l=ea(a);return a.columns.length===0?`
      ...
      <table class="summary-matrix summary-matrix-optional-rows-${l}">
        ...
        <thead>
          <tr class="summary-matrix-date-row">
            ...
            ${a.dateGroups.map(o=>`
              <th class="summary-matrix-date-heading${v(o,a)}" scope="colgroup" colspan="${o.span}">
                <span>${s(O(o.dayIndex))}</span>
          ...
          <tr>
            ${a.columns.map(o=>`
              <th class="summary-matrix-meal-heading${v(o,a)}" scope="col"><span class="summary-matrix-meal-icon" aria-hidden="true">${M(o.mealTypeId)}</span><span class="summary-matrix-meal-label">${s(k(o))}</span>${la(o,t)}</th>
            `).join("")}
          </tr>
        </thead>
        <tbody>
          ${a.hasGuestGroup?w(n("summary.guests"),"summary-matrix-row-guests",a,o=>String(o.guestCount)):""}
          ${w(n("summary.diningMeals"),"summary-matrix-row-meals",a,L)}
          ${a.hasSpecialDiets?w(n("summary.includedDiets"),"summary-matrix-row-diets",a,t?H:F):""}
          ${a.hasSickMeals?w(n("summary.sickMeals"),"summary-matrix-row-sick",a,q):""}
          ${a.hasSickDiets?w(n("summary.sickDiets"),"summary-matrix-row-sick-diets",a,K):""}
  ...
  `}function L(a,{contactHint:t=!1}={}){const e=a.total===1?"summary.cover.one":"summary.cover.other";return`<span class="summary-matrix-total">${a.total}</span><span class="summary-matrix-unit">${s(n(e))}</span>${t?P(a):""}`}function E(a){return Array.isArray(a?.names)&&a.names.some(t=>t?.phoneConsent&&C(t.phone))}function P(a,t=!0){return!t||!E(a)?"":`<small class="summary-contact-hint">${s(n("summary.contactHint"))}</small>`}function q(a){if(a.sickCount===0)return g(n("summary.sickMeals"));const t=a.sickCount===1?"summary.tray.one":"summary.tray.other";return`<span class="summary-matrix-diet-total">${a.sickCount}</span><span class="summary-matrix-unit">${s(n(t))}</span>`}function K(a){return a.sickDiets.length===0?g(n("summary.noDiet")):S(a.sickDiets)}function ia(a){if(a.massStatus==="UNKNOWN")return g(n("summary.notSet"));const t=a.massStatus==="YES";return`<span class="summary-matrix-mass-${t?"yes":"no"}">${s(n(t?"summary.yes":"summary.no"))}</span>`}function ma(a,t="name",e=!0){return`
    <tr class="summary-matrix-row-names">
      ...
      ${a.columns.map(i=>`<td class="${v(i,a).trim()}">${R(i,{compactActions:!0,residentLabel:t})}</td>`).join("")}
    </tr>
  `}function oa(a){return a==="YES"?" summary-mass-state-yes":a==="NO"?" summary-mass-state-no":" summary-mass-state-unknown"}function ua(a){const t=ya(a).map(e=>`<td class="summary-matrix-mass-band${v(e,a)}${oa(e.massStatus)}" colspan="${e.span}">${fa(e)}</td>`).join("");return`
    <tr class="summary-matrix-row-mass summary-matrix-row-mass-band">
      <th class="summary-matrix-label" scope="row">${s(n("summary.mass"))}</th>
      ${t}
    </tr>
  `}function la(a,t){if(t||a.mealTypeId!=="breakfast")return"";const e=a.breakfastPlanned===!0,r=n(e?"summary.breakfastPlanned":"summary.breakfastNotPlanned");return`<span class="summary-matrix-breakfast-status summary-matrix-breakfast-${e?"yes":"no"}"><span aria-hidden="true">${e?"✓":"×"}</span>${s(r)}</span>`}function F(a){if(a.specialDiets.participantCount===0)return g(n("summary.noDiet"));const t=[...a.specialDiets.items].sort((e,r)=>y(e.tag).localeCompare(y(r.tag),b(),{numeric:!0}));return S(t)}function H(a){return a.specialDiets.participantCount===0?g(n("summary.noDiet")):S(a.specialDiets.items," summary-matrix-kitchen-diets")}function S(a,t=""){const e=[...a].sort((r,i)=>y(r.tag).localeCompare(y(i.tag),b(),{numeric:!0}));return`<ul class="summary-matrix-diets${t}">${e.map(r=>{const i=y(r.tag),u=Math.max(0,Math.floor(Number(r.count)||0)),m=u>1?`<span class="diet-code-count">× ${u}</span>`:"";return`<li><span class="diet-code-badge diet-code-tone-${N(r.tag)}">${s(i)}</span>${m}</li>`}).join("")}</ul>`}function y(a){return Y(T(a),n)}function R(a,{compactActions:t=!1,residentLabel:e="name"}={}){return a.names.length===0?g(n("summary.noName")):`<ul class="summary-matrix-names">${a.names.map(r=>{const i=r.dietTags.map(p=>y(p)),u=C(r.phone),m=String(r.displayName||"").trim(),c=m.split(/\s+/).filter(Boolean).slice(0,3).map(p=>p[0]).join("").toUpperCase(),l=e==="signature"?r.signature||m:e==="initials"&&(r.initials||c||r.signature)||m,o=s(l),$=i.length?` <small>(${s(i.join(", "))})</small>`:"",d=`<span class="summary-matrix-person-name">${o}${$}</span>`,x=r.phoneConsent&&u?`<a class="summary-matrix-call" href="tel:${s(u)}" aria-label="${s(n("summary.callPerson",{name:r.displayName}))}"><span class="summary-matrix-phone-icon" aria-hidden="true">☎</span></a>`:"",f=r.whatsappEnabled&&r.phoneConsent&&u?`<a class="summary-matrix-whatsapp" href="https://wa.me/${s(u.replace(/\D/g,""))}" target="_blank" rel="noopener noreferrer" aria-label="${s(n("summary.messagePerson",{name:r.displayName}))}" title="WhatsApp"><img src="/icons/whatsapp.svg?v=20260808a" alt="" aria-hidden="true"></a>`:"";if(t&&(x||f)){const p=`summary-contact-popup-${++A}`;return`
          ...
          </li>`}return`<li>${d}<span class="summary-matrix-contact-actions">${x}${f}</span></li>`}).join("")}</ul>`}function C(a){const t=String(a||"").trim();return/^[+\d][\d\s()./-]{5,}$/.test(t)?t:""}function ca(a,{kitchen:t,activeIndex:e,residentLabel:r="name",showContactHint:i=!0,dietLegend:u=[]}){const m=t?"kitchen":"summary",c=a.index===e;return`
    <section class="summary-matrix-screen summary-international-screen${da(a)?" summary-screen-has-special":" summary-screen-ordinary"}" data-${m}-screen="${a.index}" role="tabpanel" aria-hidden="${!c}">
      ${t?`<h2 class="sr-only">${s(`${n("kitchen.view.title")}: ${n(a.labelKey)}`)}</h2>`:`<header class="summary-international-title"><time datetime="${s(a.dateId)}">${s(I(a.dateId))}</time></header>`}
      <div class="summary-international-grid">
        ${a.columns.map((o,$,d)=>pa(o,{kitchen:t,residentLabel:r,showContactHint:i,showMassMetadata:$===0||d[$-1]?.dateId!==o.dateId})).join("")}
      </div>
      ${t?z(a,u):""}
      ${t?W(a):""}
    </section>
  `}function da(a){return a.columns.some(t=>t.guestCount>0||t.specialDiets.participantCount>0||t.sickCount>0||t.sickDiets.length>0)||a.notesByDate.length>0}function pa(a,{kitchen:t,residentLabel:e="name",showContactHint:r=!0,showMassMetadata:i=!1}){const u=t?H(a):F(a),m=i&&a.dayMassStatus!=="UNKNOWN"?B(a.dayMassStatus):"",c=a.guestCount>0?`<span class="summary-international-mobile-guests">${s(n("summary.guests"))}: <strong>${a.guestCount}</strong></span>`:"",l=m||c?`<div class="summary-international-card-actions">${m}${c}</div>`:"";return`
    <article class="summary-international-card summary-day-tone-${G(a.dayIndex)}${a.mealTypeId==="breakfast"?" summary-international-card-next":""}">
      <header>
        <span class="summary-international-card-icon" aria-hidden="true">${M(a.mealTypeId)}</span>
        <div class="summary-international-card-copy"><strong>${s(k(a,{breakfastTomorrow:!0}))}</strong><time datetime="${s(a.dateId)}">${s(D(a.dateId))}</time></div>
        ${l}
      </header>
      <dl>
  ...
  `}function z(a,t){const e=new Set;a.columns.forEach(i=>{[...i.specialDiets?.items||[],...i.sickDiets||[]].forEach(u=>{const m=T(u?.tag);/^\d{1,3}$/.test(m)&&e.add(m)})});const r=_(t).filter(i=>e.has(i.code));return r.length===0?"":`
    <section class="kitchen-diet-legend" aria-label="${s(n("kitchen.dietLegend.title"))}">
      <h3>${s(n("kitchen.dietLegend.title"))}</h3>
      <ul>${r.map(i=>`<li><strong class="diet-code-badge diet-code-tone-${N(i.code)}">${s(y(i.code))}</strong><span aria-hidden="true">=</span><span>${s(i.label)}</span></li>`).join("")}</ul>
    </section>
  `}function g(a){return`<span class="summary-matrix-empty" aria-hidden="true">—</span><span class="sr-only">${s(a)}</span>`}function $a(a,t){return a.dayIndex>t.index?" summary-matrix-next-date":""}function fa(a){return`
    <span class="summary-mass-control">
      <span class="summary-mass-control-day">${s(O(a.dayIndex))}</span>
      <span class="summary-mass-control-state">${ia(a)}</span>
    </span>`}function v(a,t){return`${$a(a,t)} summary-day-tone-${G(a.dayIndex)}`}function G(a){return Math.max(0,Math.min(2,Number(a)||0))}function O(a){return[n("summary.today"),n("summary.tomorrow"),n("summary.dayAfterTomorrow")][a]||n("summary.followingDay")}function D(a){const[t,e,r]=String(a).split("-").map(Number);return new Intl.DateTimeFormat(b(),{day:"2-digit",month:"2-digit",year:"numeric"}).format(new Date(t,e-1,r))}function I(a){const[t,e,r]=String(a).split("-").map(Number);return!t||!e||!r?"":new Intl.DateTimeFormat(b(),{weekday:"long",day:"numeric",month:"long"}).format(new Date(t,e-1,r))}function ha(a,t){const e=[...a.querySelectorAll(`[data-${t}-screen]`)];if(e.length===0)return 0;const r=e.reduce((i,u)=>Math.abs(u.getBoundingClientRect().left-a.getBoundingClientRect().left)<Math.abs(i.getBoundingClientRect().left-a.getBoundingClientRect().left)?u:i);return Number(r.dataset[`${t}Screen`])===1?1:0}function U(a,t,e){a.querySelectorAll(`[data-${t}-screen]`).forEach(r=>{r.setAttribute("aria-hidden",String(Number(r.dataset[`${t}Screen`])!==e))})}export{Sa as mountSummaryMatrix,ta as scrollSummaryMatrix};
