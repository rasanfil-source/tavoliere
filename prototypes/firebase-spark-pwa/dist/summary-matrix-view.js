import{t as n,getLocale as x}from"./i18n/i18n.mjs?v=20260816o";import{escapeHtml as e}from"./html-utils.js?v=20260816g";import{formatDietLabel as q,normalizeDietCode as z}from"./diet-utils.mjs?v=20260816g";import{buildKitchenMatrixScreens as E,buildSummaryMatrixScreens as H}from"./summary-matrix-model.js?v=20260816g";let G=0;function oa(a,{days:t=[],operationDays:s=[],kitchen:r=!1,layout:i="classic",activeIndex:m=0,onActiveIndexChange:o=()=>{}}={}){const l=r?E(t,s):H(t,[],s);if(l.every(d=>d.columns.length===0)){a.innerHTML=`<p class="empty-state">${e(n("summary.noMeal"))}</p>`;return}const u=r?"kitchen":"summary",f=i==="international"?X:F;a.innerHTML=`
