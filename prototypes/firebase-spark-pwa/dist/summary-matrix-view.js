import{t as n,getLocale as x}from"./i18n/i18n.mjs?v=20260816h";import{escapeHtml as e}from"./html-utils.js?v=20260816g";import{formatDietLabel as q,normalizeDietCode as E}from"./diet-utils.mjs?v=20260816g";import{buildKitchenMatrixScreens as z,buildSummaryMatrixScreens as G}from"./summary-matrix-model.js?v=20260816g";let H=0;function ia(a,{days:t=[],operationDays:s=[],kitchen:r=!1,layout:m="classic",activeIndex:i=0,onActiveIndexChange:o=()=>{}}={}){const l=r?z(t,s):G(t,[],s);if(l.every(c=>c.columns.length===0)){a.innerHTML=`<p class="empty-state">${e(n("summary.noMeal"))}</p>`;return}const u=r?"kitchen":"summary",f=m==="international"?V:F;a.innerHTML=`
