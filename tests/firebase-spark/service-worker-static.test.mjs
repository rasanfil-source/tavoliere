...
test('la release corrente invalida insieme applicazione stile impostazioni e cache PWA', () => {
  assert.match(index, /styles\.css\?v=20260817a/);
  assert.match(index, /summary-matrix-refinements\.css\?v=20260816j/);
  assert.match(index, /app\.js\?v=20260817a/);
  assert.match(index, /manifest\.webmanifest\?v=20260816a/);
  assert.match(index, /launcher-192\.png\?v=20260816a/);
  assert.match(app, /center-settings\.js\?v=20260816j/);
  assert.match(serviceWorker, /CACHE_NAME = CACHE_PREFIX \+ 'v294'/);
