...
test('la release corrente invalida insieme applicazione stile impostazioni e cache PWA', () => {
  ...
  assert.match(index, /summary-matrix-refinements\.css\?v=20260821e/);
  assert.match(index, /app\.js\?v=20260821i/);
  ...
  assert.match(serviceWorker, /CACHE_NAME = CACHE_PREFIX \+ 'v362'/);
