...
test('la release corrente invalida insieme applicazione stile impostazioni e cache PWA', () => {
  ...
  assert.match(index, /summary-matrix-refinements\.css\?v=20260821f/);
  assert.match(index, /app\.js\?v=20260821k/);
  assert.match(index, /manifest\.webmanifest\?v=20260821b/);
  assert.match(index, /launcher-192\.png\?v=20260821a/);
  assert.match(app, /center-settings\.js\?v=20260821b/);
  assert.match(serviceWorker, /CACHE_NAME = CACHE_PREFIX \+ 'v364'/);
