...
test('la release corrente invalida insieme applicazione stile impostazioni e cache PWA', () => {
  assert.match(index, /styles\.css\?v=20260823i/);
  assert.match(index, /summary-matrix-refinements\.css\?v=20260823g/);
  ...
  assert.match(serviceWorker, /CACHE_NAME = CACHE_PREFIX \+ 'v423'/);
