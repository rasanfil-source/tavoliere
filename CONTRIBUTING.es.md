...
[![Italiano](https://img.shields.io/badge/lingua-Italiano-6b7280)](CONTRIBUTING.md) [![English](https://img.shields.io/badge/language-English-6b7280)](CONTRIBUTING.en.md) [![Español](https://img.shields.io/badge/idioma-Espa%C3%B1ol-16615a)](CONTRIBUTING.es.md)

Gracias por tu interés en el proyecto. Antes de proponer un cambio, abre un aviso o escribe a `rasanfil@gmail.com`, describiendo el problema, los pasos para reproducirlo y el resultado esperado.
